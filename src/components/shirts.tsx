...
let product:Iproducts[] = [
    ...
    {
     title:"GRADIANT GRAPHICS",
     id:1,
     price:"$200",
     img_url:"/image 8.png"
    },
    {
     title:"POLO WITH TIPPING SHIRT",
     id:1,
     price:"$220",
     img_url:"/image 9.png",
     old_price:"$200"
...
export default function CasualShirts(){
    return(
        <div className="w-full h-full sm:h-[500px] mt-10">
            <h1 className="text-3xl md:text-4xl font-bold text-center"> Casual </h1>
